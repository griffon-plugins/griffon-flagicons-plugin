...
----
dependencies {
    griffon '{project-group}:griffon-flagicons-plugin:{project-version}'
}
----
...
----
dependencies {
    compile '{project-group}:griffon-flagicons-swing:{project-version}'
}
----
...
----
dependencies {
    compile '{project-group}:griffon-flagicons-javafx:{project-version}'
}
----
...
----
dependencies {
    compile '{project-group}:griffon-flagicons-swing-groovy:{project-version}'
}
----
...
----
dependencies {
    compile '{project-group}:griffon-flagicons-javafx-groovy:{project-version}'
}
----

== Maven

First configure the `griffon-flagicons-plugin` BOM in your POM file, by placing the following
