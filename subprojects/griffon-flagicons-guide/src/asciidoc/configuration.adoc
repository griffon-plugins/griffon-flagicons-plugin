...
----
dependencies {
    griffon '{groupId}:griffon-flagicons-plugin:{project-version}'
}
----
...
----
dependencies {
    compile '{groupId}:griffon-flagicons-swing:{project-version}'
}
----
...
----
dependencies {
    compile '{groupId}:griffon-flagicons-javafx:{project-version}'
}
----
...
----
dependencies {
    compile '{groupId}:griffon-flagicons-swing-groovy:{project-version}'
}
----
...
----
dependencies {
    compile '{groupId}:griffon-flagicons-javafx-groovy:{project-version}'
}
----
