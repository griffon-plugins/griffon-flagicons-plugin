...
public final class Country implements Comparable<Country> {
    ...
    public String asResource() {
        return "com/famfamfam/flags/icons/" + getCode().toLowerCase() + ".png";
    }

    private static ResourceBundle getBundle() {
        synchronized (Country.class) {
            if (COUNTRY_NAMES == null) {
                COUNTRY_NAMES = ResourceBundle.getBundle(Country.class.getPackage().getName() + ".countrynames",
    ...
    public boolean equals(Object o) {
        ...
        Country c = (Country) o;
        return code.equals(c.code) && name.equals(c.name);
    }

    public int hashCode() {
        return (code.hashCode() * 37) + (name.hashCode() * 31);
    }

    public int compareTo(@Nonnull Country c) {
        return code.compareTo(c.code);
    }

    @Nonnull
    public static Country findByCode(@Nonnull String code) {
